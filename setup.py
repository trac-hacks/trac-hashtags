...
from trachashtags.__init__ import __doc__ as DESC
...
DIST_NM = 'TracHashTags'
PKG_INFO = {'trachashtags' : ('trachashtags',                     # Package dir
                            # Package data
...
setup(
    ...
    maintainer_email='olemis+trac@gmail.com',
	  url='https://github.com/nothingagency/trac-hashtags',
    download_url='http://pypi.python.org/packages/%s/%s/%s/%s-%s-py2.5.egg' % \
